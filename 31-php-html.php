...
<body>
    ...
    <?php for ($contador=0; $contador<=10; $contador++){ ?>
        <h2> <?php echo "Actualmente estamos en la iteración $contador"; ?> </h2>
        
        <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="https://randomfox.ca/images/4.jpg" alt="Card image cap">
            <div class="card-body">
